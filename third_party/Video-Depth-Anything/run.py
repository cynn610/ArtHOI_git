...
if __name__ == '__main__':
    ...
    parser.add_argument('--input_video', '--iv', type=str, default='./assets/example_videos/davis_rollercoaster.mp4')
    ...
    checkpoint_path = os.path.join(
        SCRIPT_DIR, 'checkpoints', f'{checkpoint_name}_{args.encoder}.pth'
    )
