...
def load_wilor(checkpoint_path, cfg_path, override_cfg=None):
    ...
    model_cfg = (
        ...
        else get_config(cfg_path, update_cachedir=True)
    )
    ...
    if ('DATA_DIR' in model_cfg.MANO) and override_cfg is None:
        model_cfg.defrost()
