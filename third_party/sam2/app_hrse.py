...
if __name__ == "__main__":
    ...
    parser.add_argument("--checkpoint_dir", type=str, default=os.path.join(FILE_LOC, "checkpoints", "sam2.1_hiera_base_plus.pt"))
    parser.add_argument("--model_cfg", type=str, default=os.path.join(FILE_LOC, "sam2", "configs", "sam2.1", "sam2.1_hiera_b+.yaml"))
